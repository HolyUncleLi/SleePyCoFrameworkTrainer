...
def get_experiment_args():
    ...
    parser.add_argument('--config_file', type=str, default='./configs/MSA_CNN_large.json', help='configuration file')
    parser.add_argument('--verbose', default='1',  help='verbose level, 0=silent, 1=progress bar, 2=one line per epoch')
    parser.add_argument('--gpu', default='-1', help='which gpu to use')
    parser.add_argument('--rerun_configs',default=False, help='rerun configurations even if present in overview')
    parser.add_argument('--dry_run', default=False, help='do not save results')
